...
- **R4.** The docs frame this honestly as **fail-closed** (case 1 denies; case 2 only exposes a view affordance the Guard still 403s) — a **diagnosability** gap, not a bypass — so a reader doesn't mistake it for a security hole.
